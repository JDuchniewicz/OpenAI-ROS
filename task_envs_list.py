...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    elif task_env == 'TurtleBotCustom-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot3_custom.turtlebot3_custom:TurtleBotCustomEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.turtlebot3_custom import turtlebot3_custom
